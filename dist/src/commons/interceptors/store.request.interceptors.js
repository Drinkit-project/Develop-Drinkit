...
let TransformBodyInterceptor = exports.TransformBodyInterceptor = class TransformBodyInterceptor {
    ...
    async intercept(context, next) {
        ...
        const { address, name, description, businessLicense, lat, lng } = request.body;
        const upload = await this.uploadFileToS3('store', request.file);
        request.body = {
            address,
            name,
            description,
...
//# sourceMappingURL=store.request.interceptors.js.map